...
public class ViewUtils {
    ...
    public static void runOnUiThread(final Runnable runnable) {
        androidx.swift.util.UtilsBridge.runOnUiThread(runnable);
    }
    ...
    public static void runOnUiThreadDelayed(final Runnable runnable, long delayMillis) {
        androidx.swift.util.UtilsBridge.runOnUiThreadDelayed(runnable, delayMillis);
    }
    ...
    public static boolean isLayoutRtl() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                primaryLocale = androidx.swift.util.Utils.getApp().getResources().getConfiguration().getLocales().get(0);
            } else {
                primaryLocale = androidx.swift.util.Utils.getApp().getResources().getConfiguration().locale;
            }
